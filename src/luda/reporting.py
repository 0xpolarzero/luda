...
def project_health(value):
    ...
    for name, fields in [('ocr', ('available',)), ('keyboard', ('available',)), ('control', ('available', 'paused')), ('session_state', ('input_ready',))]:
        item = value.get(name)
