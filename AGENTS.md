...
- Keep runtime source, documentation, skill and schemas aligned. Use explicit account selection for test environments; do not hardcode a desktop account in the product.
...
Scope: standalone Linux computer-use plugin, skill and tools. Do not add sandbox-manager integrations, Mac acceptance gates, or speculative catalog extensions.
