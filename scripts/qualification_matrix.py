...
SUITES = {
    ...
    'owned-browser': suite('live_owned_browser.py', 'WEB-01 WEB-02 MCP-08', browser='--executable', artifacts=('owned-browser',), gaps=('Optional owned Chromium HTML fields only; rich editors/frames unsupported',)),
