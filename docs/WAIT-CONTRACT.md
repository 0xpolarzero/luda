...
Run the live suite in an isolated Xvfb/XFWM4/session-D-Bus desktop, or hold `/tmp/luda-live-tests.lock` for the entire run against `:1`. Results go to `artifacts/waits/results.json`.
