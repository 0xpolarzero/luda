...
The [GTK3/GTK4 read-only feasibility audit](NATIVE-IME-FEASIBILITY.md) adds four pending-preedit observations and an explicit field-binding/late-attach analysis. It does not implement a generic native guard or qualify EDIT-10.
