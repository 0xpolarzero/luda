...
```python
desktop_type(element_id: str, text: str, mode: Literal['insert', 'replace']='insert', line_breaks: Literal['paragraph'] | None=None, transport: Literal['native', 'clipboard']='native')
```
