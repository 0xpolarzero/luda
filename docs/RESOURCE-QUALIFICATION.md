...
The separate [public MCP soak](MCP-SOAK-QUALIFICATION.md) records a 600-second ordinary-user session with independent input effects, per-request latency, process/descriptor/RSS samples and normal disconnect cleanup. It remains measured ten-minute evidence, not hours-long endurance qualification.
